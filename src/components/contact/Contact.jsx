        ...
        <form action="" className="contact__form">
          <div className="contact__form-group">
            ...
            <div className="contact__form-div">
              <input type="Text" className="contact__form-input" placeholder='Ingresa tu Nombre' />
            </div>

            <div className="contact__form-div">
              <input type="Email" className="contact__form-input" placeholder='Ingresa tu Email' />
            </div>
          </div>
